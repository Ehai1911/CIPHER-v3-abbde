...
const TAB_SCHEMAS = {
  ...
  pricing: `{"pricing":{"headers":["Компания","Модель","Старт цена","Бесплатно","Пробный период","Годовая скидка"],"rows":[["Н1","За пользователя","$X/мес","✅","14д","-20%"],["Н2","За пользователя","$X/мес","❌","7д","-18%"],["Н3","Бесплатный план","$X/мес","✅","—","-20%"],["Н4","За пользователя","$X/мес","❌","—","нет"],["Н5","Бесплатный план","$X/мес","✅","—","-45%"]],"summary":["конкретный вывод1","конкретный вывод2","конкретный вывод3"],"bestCompany":"Н","bestAdvice":"совет","chart":[{"name":"Н1","url":"https://competitor1.com","start":10.99,"color":"#60a5fa"},{"name":"Н2","url":"https://competitor2.com","start":9,"color":"#a78bfa"},{"name":"Н3","url":"https://competitor3.com","start":8,"color":"#34d399"},{"name":"Н4","url":"https://competitor4.com","start":5,"color":"#f87171"},{"name":"Н5","url":"https://competitor5.com","start":7,"color":"#fbbf24"}],"recommendation":{"model":"Freemium","freeLimit":"X проектов, Y пользователей","startPrice":"$X/мес","annualDiscount":"-30%","why":"Конкретное объяснение: почему эта модель лучшая для данного рынка и чем выигрывает у конкурентов"}}}`,
